...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  const PRICE_ID = "price_1SCMAlLAge6tJYbWmfzBLb5k"; // Replace with your actual price ID
  ...
  async function checkPaymentStatus(userId) {
    try {
      ...
      for (const doc of querySnapshot.docs) {
        ...
        if (
          (paymentData.amount === 1499 || paymentData.amount === "1499") &&
      ...
      for (const doc of rootSnapshot.docs) {
        ...
        // Note: Check both number and string representations of amount
        if (
          (paymentData.amount === 1000 || paymentData.amount === "1000") &&
                ...
                const unsubscribe = onSnapshot(docRef, (snap) => {
                  ...
                  `;
                    ...
                    `;
                      ...
                      const newDonateButton =
                        document.getElementById("donateButton");
                      newDonateButton.addEventListener(
                        "click",
                        handleDonateClick
                      );
                    });
